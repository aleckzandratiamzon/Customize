                        ...
                        @csrf
                            <div class="flex flex-wrap gap-4">
                                ...
                                <div class="w-full">
                                    ...
                                    <input name="email" type="email" id="email" required placeholder="Email Address" maxlength="50"
                                ...
                                <div class="w-full">
                                    ...
                                    <input name="password" type="password" id="password" required placeholder="Password" maxlength="50"
                                        class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm
                                ...
                                <div class="w-full">
                                    ...
                                    <input name="password_confirmation" type="password" id="password_confirmation" placeholder="Confirm Password" maxlength="50"
                                        class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm

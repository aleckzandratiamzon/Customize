                    ...
                    <div class="accordion category-name" id="accordionExample">
                        <div class="accordion-item category-rating">
                            <h2 class="accordion-header mb-2" id="headingTwo">
                                <button class="bg-white px-3 py-2 rounded w-100 text-left flex justify-start  font-bold text-lg" type="button" data-bs-toggle="collapse" data-bs-target="">
                                    Category
                                </button>
                            </h2>
            ...
            <div class="category-product col-lg-9 col-12 ratio_30">
                ...
                <div class="category-product col-lg-9 col-12 ratio_30">
                    <div class="row g-sm-4 g-3 row-cols-lg-4 row-cols-md-3 row-cols-2 mt-1 custom-gy-5 product-style-2 ratio_asos product-list-section">
                        @foreach ($product as $product) <!-- Make sure to use the correct loop variable
                        here -->
                        <div>
